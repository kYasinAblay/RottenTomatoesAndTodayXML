#pragma checksum "C:\Users\Kamil\source\repos\TodayXML\TodayXML.MVCcore\Views\Home\Movies.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "97a4a972242e6e54bf20b09b8f23dea18eee933a"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"97a4a972242e6e54bf20b09b8f23dea18eee933a", @"/Views/Home/Movies.cshtml")]
...
#nullable disable
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "97a4a972242e6e54bf20b09b8f23dea18eee933a6307", async() => {
                WriteLiteral(@"
...
#nullable disable
    ...
    <script>
        ...
        $(""#inputBtn"").bind(""click"", function (event) {
            ...
            if ($(""#myInput"").val()) {
                ...
                function ScrollLocalStroge() {
                    alert(""ScrollLocalStroge içerdeyim"");
                    let a = 1;
                    var lastValue = [];
      ...
      ");
                WriteLiteral("      setTimeout(function () { $(\"#inputBtn\").click(); }, 500);\r\n        });\r\n    </script>\r\n");
            }
            );
        }
