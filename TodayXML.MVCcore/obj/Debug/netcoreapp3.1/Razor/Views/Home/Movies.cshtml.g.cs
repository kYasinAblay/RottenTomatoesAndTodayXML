#pragma checksum "C:\Users\Kamil\source\repos\TodayXML\TodayXML.MVCcore\Views\Home\Movies.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "3170cf65bf59c1a39739482539f3a4562683e9ba"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"3170cf65bf59c1a39739482539f3a4562683e9ba", @"/Views/Home/Movies.cshtml")]
...
#nullable disable
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "3170cf65bf59c1a39739482539f3a4562683e9ba6307", async() => {
                WriteLiteral(@"
...
#nullable disable
    ...
    <script>
        ...
        $(""#inputBtn"").bind(""click"", function (event) {
            ...
            var localTerm5Full = localStorage.hasOwnProperty(""sear");
                WriteLiteral(@"chTerm5"");
                ...
                switch (parseInt(counter)) {
                    case 1:
                        if (localTerm5Full) {
                            ...
                            $(""#searchTerm5"").text(localStorage.getItem(""searc");
                WriteLiteral(@"hTerm1""));
                    ...
                    case 4:
                        ...
                        $(""#searc");
                WriteLiteral(@"hTerm2"").attr(""href"", href + localStorage.getItem(""searchTerm4""));
                    ...
                    while (a <= 6) {
                        ...
                        if (lastValue.length < 5) {
                            ...
                            if (localStorage.hasOwnProperty(""searchTerm6"")) {
                               ...
                               ");
                WriteLiteral(@" lastValue.push(localStorage.getItem(""searchTerm6""));
                                lastValue.shift();
                                for (var i = 1; i <= lastValue.length; i++) {
                                    $(""#searchTerm"" + i.toString()).val(lastValue[5 - i])
                                }
                            }
                        }
                        a++;
            ...
            setTimeout(funct");
                WriteLiteral("ion () { $(\"#inputBtn\").click(); }, 500);\r\n        });\r\n    </script>\r\n");
            }
            );
        }
